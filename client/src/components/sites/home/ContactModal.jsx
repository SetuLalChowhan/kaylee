    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4 overflow-y-auto">
        ...
        <motion.div
          ...
          className="relative w-full max-w-2xl bg-white rounded-[32px] shadow-2xl pt-6 md:pt-10 pb-0 px-0 z-20 flex flex-col font-urbanist max-h-[90vh] overflow-y-auto md:overflow-hidden"
        >
          {/* Header */}
          <div className="px-6 md:px-10 pr-16 pb-1">
          ...
          <button
            onClick={onClose}
            className="absolute top-5 right-5 md:top-8 md:right-10 text-gray-400 hover:text-gray-600 transition-colors cursor-pointer z-30"
          ...
          {/* Dashed Line */}
          <div className="w-full border-b border-dashed border-gray-200/80 my-4" />

          {/* Scrollable Form Content */}
          <div className="flex-1 overflow-visible md:overflow-y-auto px-6 md:px-10 pb-6 pt-2 custom-scrollbar">
