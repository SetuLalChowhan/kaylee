...
export class WebhookService {
  ...
  static async handleSubscriptionUpdated(stripeSub: Stripe.Subscription) {
    const subObj = stripeSub as any;
    const sub = await prisma.subscription.findUnique({
  ...
  static async handleSubscriptionDeleted(stripeSub: Stripe.Subscription) {
    const subObj = stripeSub as any;
    const sub = await prisma.subscription.findUnique({
      where: { stripeSubscriptionId: subObj.id },
    });
