 ...
 */
export const adminGetPayments = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
 ...
 */
export const adminCancelPurchase = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
