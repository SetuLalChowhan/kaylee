...
export declare const resendVerificationLink: (req: Request, res: Response, next: NextFunction) => void;
export declare const resendForgotPasswordLink: (req: Request, res: Response, next: NextFunction) => void;
